...
QString toQString(const ClientQueryType &value) {
    switch (value) {
        ...
        case ClientQueryType::SetGlobalData:
            return "GD";
        case ClientQueryType::SimTime:
            return "SIMTIME";
        case ClientQueryType::SDILS:
            return "SDILS";
        case ClientQueryType::SimTag:
            return "IS";
        case ClientQueryType::SCOMM:
            return "SCOMM";
...
ClientQueryType fromQString(const QString &str) {
    ...
    if (str == "ATC") {
        ...
        return ClientQueryType::SimTime;
    } else if (str == "SDILS") {
        return ClientQueryType::SDILS;
    } else if (str == "IS") {
        return ClientQueryType::SimTag;
    } else if (str == "SCOMM") {
